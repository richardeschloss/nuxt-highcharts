<template>
  <div id="app">
    ...
    <div class="button-grp">
      <button :class="{btnActive: selected === 'chart'}" @click="select('chart')">
        Chart
      </button>
      <button :class="{btnActive: selected === 'stockChart'}" @click="select('stockChart')">
        Stock Chart
      </button>
      <button :class="{btnActive: selected === 'mapChart'}" @click="select('mapChart')">
        Map Chart
      </button>
    </div>
    <keep-alive>
