    ...
    <div class="row">
      <div class="col-3-auto col-md-3">
        <div id="chartType">
          ...
          <b-form-select v-model="chartType" :options="chartTypes" />
        </div>
        ...
        <div id="sexy-bkg">
          <b-form-checkbox v-model="sexy"> Make it sexy </b-form-checkbox>
        </div>
      ...
      <div class="col-9-auto col-md-9">
        ...
        <div>
          ...
          <label
            >^^------------ Modify the series data (reactively)
            ------------^^</label
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    chartLoaded(chart) {
      ...
      console.log(
        'If you need to interact with the API directly, here you go!',
        chart
      )
      console.log(
        'Helpul tip: away from the docs? chart.__proto__ in dev tools will show you the methods:',
